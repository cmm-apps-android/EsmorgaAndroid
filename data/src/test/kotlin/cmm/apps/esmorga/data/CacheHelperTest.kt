...
class CacheHelperTest {
    ...
    @Test
    fun `given a date three minutes in the past when checking if cache should be used then true should be returned`() {
        val threeMinutes = 3 * 60 * 1000
        val shouldUseCache = CacheHelper.shouldReturnCache(System.currentTimeMillis() - threeMinutes)
