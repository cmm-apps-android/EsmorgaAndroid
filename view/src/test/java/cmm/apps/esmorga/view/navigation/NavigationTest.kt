...
import cmm.apps.esmorga.view.createevent.CreateEventFormScreenTestTags
...
class NavigationTest {
    ...
    @Test
    fun `given user in CreateEventTypeScreen when clicks back then navigates back to CreateEventFormScreen`() {
        setNavigationFromDestination(Navigation.CreateEventFormScreen)
        composeTestRule.waitForIdle()

        composeTestRule.onNodeWithTag(CreateEventFormScreenTestTags.CREATE_EVENT_FORM_TITLE).assertIsDisplayed()

        composeTestRule.onNodeWithTag(CreateEventFormScreenTestTags.CREATE_EVENT_FORM_NAME).performTextInput("Description for name type test")
        composeTestRule.onNodeWithTag(CreateEventFormScreenTestTags.CREATE_EVENT_FORM_DESCRIPTION).performTextInput("Description for event type test")
        composeTestRule.onNodeWithTag(CreateEventFormScreenTestTags.CREATE_EVENT_FORM_NEXT_BUTTON).performClick()
        composeTestRule.waitForIdle()
