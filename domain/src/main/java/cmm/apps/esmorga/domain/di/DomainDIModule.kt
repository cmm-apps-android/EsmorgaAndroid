...
import cmm.apps.esmorga.domain.event.UpdateEventAttendeesUseCase
import cmm.apps.esmorga.domain.event.UpdateEventAttendeesUseCaseImpl
...
object DomainDIModule {
    ...
    val module = module {
        ...
        factory<UpdateEventAttendeesUseCase> { UpdateEventAttendeesUseCaseImpl(get()) }
